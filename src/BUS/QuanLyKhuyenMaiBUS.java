...
public class QuanLyKhuyenMaiBUS {
    ...
    public String[] getHeaders() {
        return new String[] { "Mã khuyến mãi", "Tên khuyến mãi", "Điều kiện khuyến mãi", "Phần trăm khuyến mãi",
    ...
    public ArrayList<KhuyenMai> search(String value, String type, int dk1, int dk2, float phantram1, float phantram2,
        ...
        for (int i = result.size() - 1; i >= 0; i--) {
            ...
            Boolean phantramKhongThoa = (phantram1 != -1 && phantram < phantram1)
                    || (phantram2 != -1 && phantram > phantram2);
            Boolean ngayBDKhongThoa = (ngay1 != null && ngaybd.isBefore(ngay1))
                    || (ngay2 != null && ngaybd.isAfter(ngay2));
            Boolean ngayKTKhongThoa = (ngay1 != null && ngaykt.isBefore(ngay1))
                    || (ngay2 != null && ngaykt.isAfter(ngay2));
