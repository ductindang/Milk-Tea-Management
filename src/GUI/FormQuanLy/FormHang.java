    ...
    public void setDataToTable(ArrayList<ChiTietPhieuNhap> arr, MyTable t) {
        ...
        for (ChiTietPhieuNhap ctpn : arr) {
            ...
            t.addRow(new String[] {
                    ...
                    Format_money.format(dongia),
                    Format_money.format(thanhtien)
            });
            stt++;
            tongtien += thanhtien;
        }
        ...
        // check khuyến mãi
        t.addRow(new String[] { "", "", "", "", "", "" });
        t.addRow(new String[] { "", "", "", "", "Tổng tiền", Format_money.format(tongtien) });
...
class HoaDonBanHang extends FormHang {
    ...
    public HoaDonBanHang(int _x, int _y, int _width, int _height) {
        ...
        btnHuy.setIcon(new ImageIcon(this.getClass().getResource("/images/icons8_cancel_30px_1.png")));
        btnThanhToan.setIcon(new ImageIcon(this.getClass().getResource("/images/icons8_us_dollar_30px.png")));
            ...
            if (cthd.getMaSanPham().equals(sp.getMaSP())) {
                ...
                if (tongSoLuong > sp.getSoLuong()) {
                    JOptionPane.showMessageDialog(this,
                            "Số lượng sản phẩm trong kho không đủ (" + sp.getSoLuong() + ")");
                    return;
                }
    ...
    public void setDataToTable(ArrayList<ChiTietHoaDon> arr, MyTable t) {
        ...
        if (khuyenMai != null && khuyenMai.getPhanTramKM() > 0 && khuyenMai.getDieuKienKM() <= tongtien) {
            ...
            t.addRow(new String[] { "", "", "", "", "Khuyến mãi", Format_money.format(-giaTriKhuyenMai) });
            t.addRow(new String[] { "", "", "", "", "Còn lại", Format_money.format(tongTienSauKhuyenMai) });
            ...
            for (SanPham sp : qlspBUS.getDssp()) {
                if (sp.getMaSP().equals(masp)) {
                    ...
                    ImageIcon img = new ImageIcon(
                            getClass().getResource("/images/Product Images/" + sp.getFileNameHinhAnh()));
                    ...
                    txDonGia.setText(Format_money.format(sp.getDonGia()));
        ...
        for (SanPham sp : data) {
            if (sp.getTrangThai() == 0) {
                table.addRow(new String[] {
                        ...
                        sp.getMaLSP(),
                        sp.getTenSP(),
                        Format_money.format(sp.getDonGia()),
