...
public class ThongKeForm extends JPanel {
    ...
    public ThongKeForm() {
        ...
        tabs.addTab("Sản phẩm", getIcon("icon8_trasua_3.png"), null);
...
class ThongKe_Hoang extends JPanel {
    ...
    public ThongKe_Hoang() {
        ...
        new DateButton(dPicker1);
        new DateButton(dPicker2);
        ...
        tbThongKeHoaDon.setHeaders(new String[] { "Hóa đơn", "Tên nhân viên", "Tên khách hàng", "Tên sản phẩm",
        ...
        tbThongKePhieuNhap.setHeaders(new String[] { "Phiếu nhập", "Tên nhân viên", "Tên nhà cung cấp", "Tên sản phẩm",
                "Số lượng", "Đơn giá", "Thành tiền" });
    ...
    private void setDataToPanelTong() {
        ...
        plThongKeSoLuong
                .add(getJPanelTong("SẢN PHẨM", "icon8_trasua_2.png", qlspBUS.getDssp().size(), Color.BLUE));
        plThongKeSoLuong
                .add(getJPanelTong("NHÂN VIÊN", "icons8_assistant_100px.png", qlnvBUS.getDsnv().size(), Color.BLUE));
        plThongKeSoLuong
                .add(getJPanelTong("KHÁCH HÀNG", "icons8_person_male_100px.png", qlkhBUS.getDskh().size(), Color.BLUE));
        plThongKeSoLuong
                .add(getJPanelTong("NHÀ CUNG CẤP", "icons8_company_100px.png", qlnccBUS.getDsncc().size(), Color.BLUE));
    }
    ...
    private void onChangeThongKeBanHang() {
        ...
        for (HoaDon hd : qlhdBUS.search("Tất cả", "", mcd.getNgayTu(), mcd.getNgayDen(), -1, -1)) {
            ...
            if (dscthd.size() > 0) {
                ...
                for (ChiTietHoaDon cthd : dscthd) {
                    ...
                    tbThongKeHoaDon.addRow(new String[] { "", "", "",
                            ...
                            Format_money.format(cthd.getDonGia()),
                            Format_money.format(cthd.getSoLuong() * cthd.getDonGia())
                    });
            ...
            tbThongKeHoaDon.addRow(new String[] { "", "", "", "", "", "Tổng cộng", Format_money.format(tongTien) });
            tbThongKeHoaDon.addRow(new String[] { "", "", "", "", "", "", "" });
        ...
        tbKetQuaHoaDon.addRow(new String[] {
                ...
                "",
                Format_money.format(tongTatCaTien)
        });
    }
    ...
    private void onChangeThongKeNhapHang() {
        ...
        for (PhieuNhap pn : qlpnBUS.search("Tất cả", "", mcd.getNgayTu(), mcd.getNgayDen(), -1, -1)) {
            ...
            if (dsctpn.size() > 0) {
                ...
                for (ChiTietPhieuNhap ctpn : dsctpn) {
                    ...
                    tbThongKePhieuNhap.addRow(new String[] { "", "", "",
                            ...
                            Format_money.format(ctpn.getDonGia()),
            ...
            tbThongKePhieuNhap
                    .addRow(new String[] { "", "", "", "", "", "Tổng cộng", Format_money.format(tongTien) });
            tbThongKePhieuNhap.addRow(new String[] { "", "", "", "", "", "", "" });
