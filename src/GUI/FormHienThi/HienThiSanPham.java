...
public class HienThiSanPham extends FormHienThi {
    ...
    public HienThiSanPham() {
        ...
        mtb.setHeaders(new String[] { "STT", "Mã sản phẩm", "Mã loại", "Tên", "Đơn giá (vnd)", "Số lượng", "Hình ảnh",
                "Trạng thái" });
        ...
        cbTypeSearch = new JComboBox<>(
                new String[] { "Tất cả", "Mã sản phẩm", "Mã loại", "Tên", "Đơn giá", "Số lượng", "Trạng thái" });
