...
public class HienThiHoaDon extends FormHienThi {
    ...
    // JComboBox<String> cbTypeSearch = new JComboBox(new String[] { "Tất cả", "Mã
    // hóa đơn", "Mã nhân viên",
    // "Mã khuyến mãi", "Mã khách hàng", "Ngày lập", "Giờ lập", "Tổng tiền" });
    JComboBox<String> cbTypeSearch = new JComboBox<>(new String[] { "Tất cả", "Mã hóa đơn", "Mã nhân viên",
            "Mã khuyến mãi", "Mã khách hàng", "Ngày lập", "Giờ lập", "Tổng tiền" });
    ...
    public HienThiHoaDon() {
        ...
        mtb = new MyTable();
        mtb.setHeaders(new String[] { "STT", "Mã hóa đơn", "Mã nhân viên", "Mã khách hàng", "Mã khuyến mãi", "Ngày lập",
                "Giờ lập", "Tổng tiền" });
        ...
        btnDetails.setIcon(new ImageIcon(this.getClass().getResource("/images/icons8_show_property_30px.png")));
        ...
        txTongTien.setBorder(BorderFactory.createTitledBorder("Tổng tiền (vnd):"));
        ...
        if (mahd != null) {
            ...
            for (HoaDon hd : qlhd.getDshd()) {
                if (hd.getMaHoaDon().equals(mahd)) {
                    ...
                    txTongTien.setText(Format_money.format(hd.getTongTien()));
                    return;
                }
            }
        }
    ...
    private void txSearchOnChange() {
        ...
        setDataToTable(
                qlhd.search(cbTypeSearch.getSelectedItem().toString(), txTim.getText(), ngay1, ngay2, tong1, tong2),
                mtb);
    }
