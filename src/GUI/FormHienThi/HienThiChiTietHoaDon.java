...
public class HienThiChiTietHoaDon extends FormHienThi {
    ...
    JComboBox<String> cbTypeSearch = new JComboBox<>(new String[] { "Tất cả", "Mã sản phẩm", "Số lượng", "Đơn giá" });
    ...
    private void txSearchOnChange() {
        ...
        qlcthd.search(cbTypeSearch.getSelectedItem().toString(), txTim.getText(), soLuong1, soLuong2, thanhTien1,
                thanhTien2).forEach((t) -> {
